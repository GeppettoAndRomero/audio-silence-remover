...
export const ui = {
  en: {
    ...
    thresholdLabel: 'Silence threshold', minSilenceLabel: 'Minimum silence (seconds)', removeButton: 'Remove silence', processing: 'Processing…',
    ...
    dzDropSub: 'Drop audio to trim its silences',
  ...
  ja: {
    ...
    settingsButton: '設定',
    thresholdLabel: '無音のしきい値', minSilenceLabel: '無音と見なす長さ（秒）', removeButton: '無音を除去', processing: '処理中…',
  ...
  zh: {
    ...
    settingsButton: '设置',
    thresholdLabel: '静音阈值', minSilenceLabel: '最短静音时长（秒）', removeButton: '去除静音', processing: '正在处理…',
  ...
  de: {
    ...
    thresholdLabel: 'Stille-Schwelle', minSilenceLabel: 'Mindeststille (Sekunden)', removeButton: 'Stille entfernen', processing: 'Wird verarbeitet…',
    ...
    dzDropSub: 'Lege Audio ab, um Stille zu entfernen',
  ...
  es: {
    ...
    thresholdLabel: 'Umbral de silencio', minSilenceLabel: 'Silencio mínimo (segundos)', removeButton: 'Quitar silencios', processing: 'Procesando…',
    ...
    dzDropSub: 'Suelta audio para quitar los silencios',
